class Media {
  ...
  set isCheckedOut(toggleCheckedOutStatus) {
    this._isCheckedOut = toggleCheckedOutStatus;
  }
}
...
const historyOfEverything = new Book('Bill Bryson', 'A Stort History of Nearly Everything', 544);
